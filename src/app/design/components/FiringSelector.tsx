...
const CONE_OPTIONS: { value: string; label: string; tempF: string; tempC: string; available: boolean }[] = [
  ...
  { value: '4',  label: 'Cone 4',   tempF: '2167°F', tempC: '1186°C', available: false },
  { value: '5',  label: 'Cone 5',   tempF: '2185°F', tempC: '1196°C', available: false },
  { value: '6',  label: 'Cone 6',   tempF: '2232°F', tempC: '1222°C', available: true },
  { value: '7',  label: 'Cone 7',   tempF: '2264°F', tempC: '1240°C', available: false },
  { value: '8',  label: 'Cone 8',   tempF: '2300°F', tempC: '1260°C', available: false },
  { value: '9',  label: 'Cone 9',   tempF: '2336°F', tempC: '1280°C', available: false },
